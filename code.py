...
class About(Toplevel):
    def __init__(self, root):
        ...
        my_canvas.create_text(250, 450, text = 'M.V.Hareesh', font = ("High Tower Text", 30), fill = "#006b56", anchor = "nw")
        my_canvas.create_text(250, 500, text = 'R.S.Rakthaksh', font = ("High Tower Text", 30), fill = "#006b56", anchor = "nw")
        my_canvas.create_text(250, 550, text = 'S.Shivnarayan', font = ("High Tower Text", 30), fill = "#006b56", anchor = "nw")
